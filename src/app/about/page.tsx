                ...
                <section className={styles.cover}>
                    ...
                    <div className={styles.partners}>
                        ...
                        <div className={styles.logoRow}>
                            {[
                                { src: '/logos/01_HanwhaVision.png', alt: '한화비전' },
                                { src: '/logos/02_TheHyundai.png', alt: '더현대' },
                                { src: '/logos/03_Shinsegae.jpg', alt: '신세계' },
                                { src: '/logos/04_DnB.png', alt: 'D&B' },
                                { src: '/logos/05_POCA.png', alt: 'POCA' },
                                { src: '/logos/06_KyonggiUniv.png', alt: '경기대학교' },
                                { src: '/logos/07_JungSaemMool.png', alt: '정샘물' },
                                { src: '/logos/08_DECODE_Q.png', alt: 'DECODE Q' },
                                { src: '/logos/09_Sihyunhada.png', alt: '시현하다' },
                                ...
                                { src: '/logos/17_ChingchanMoa.png', alt: '칭찬모아' },
